...
namespace MenuNS {
    ...
    public class Menu : IMenu {
        ...
        /// <summary>
        /// Attribut indiquant si le nom affiché est "Menu ..." ou overridé pour afficher
        /// </summary>
        ...
        public string TexteMenu { get { return ToString(); } }
        ...
        public Menu(List<IMenuItem> items, string nom, bool overrideNom = false) {
            Items = items;
            Nom = nom;
