...
namespace ClassesClubTennis.Acteurs
{
    sealed class EntraineurSalarie : Membre, IEntraineur, ISalarie, ICompetiteur
    {
        ...
        public EntraineurSalarie(string nom, string prenom, TypeSexe sexe, DateTime dateNaissance, string numeroTelephone, Adresse adresse, bool estCompetiteur, double salaire,
            DateTime dateEntreeClub, InfoBancaire informationsBancaires, Classement.ValClassement classement, int nombreDeCoursAEffectuer = 0, TypeMembre type = TypeMembre.Personnel)
